...
<html>
	<head>
		...
		<script src="js/scriptTp4.js"></script>
	</head>
				...
				<div class="section_centrale col-md-4">
					...
					<div class="contenu tab-content">
		            	<div id="connexion" class="tab-pane fade in active">
		                	<form id="leFormulaire" name="formLogin" action="LoginController?action=loginClient" method="post">
		                		<div class="col-md-1"></div>
		                	 	<div class="col-md-8">
		            				...
		            				<hr>
								    <div class="type-compte">
								      <input type="radio" value="Personne" id="compte-client" name="typeCompte" checked/>
								      <label for="compte-client" class="radio" checked>Homme</label>
								      <input type="radio" value="Entreprise" id="compte-entrepise" name="typeCompte" />
			    		...
			    		<div id="inscription" class="tab-pane fade">
			                <form id="leFormulaire2" name="formInscription" action="LoginController?action=inscriptionClient" method="post">
			                	<div class="col-md-1"></div>
			                	<div class="col-md-8">
